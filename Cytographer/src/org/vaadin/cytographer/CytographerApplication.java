...
public class CytographerApplication extends Application implements GraphChangeListener {
	...
	private Component getAttributeBrowser(final Cytographer graph) {
		...
		selectedNodesTables.setContainerDataSource(graph.getNodeAttributeContainerForSelectedNodes());
	...
	private Component getStyleSelect() {
		...
		styleSelect.addListener(new Property.ValueChangeListener() {
			...
			public void valueChange(final ValueChangeEvent event) {
				...
				final Cytographer g = getNetworkGraph(WIDTH, HEIGHT);
	...
	private Cytographer getNetworkGraph(final int width, final int height) {
		if (reLayout) {
		...
		final Cytographer graph = new Cytographer(net, view, "test", width, height);
